...
const Root = () => {
  ...
  return (
    ...
    >
      {/* Light transparent overlay to make text readable */}
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex items-center justify-center px-4 md:px-10 py-10 flex-grow">
          <div className="w-full max-w-6xl bg-white/10 backdrop-blur-md rounded-3xl overflow-hidden shadow-[0_0_25px_rgba(0,0,0,0.4)] flex flex-col md:flex-row border border-white/20">
            {/* Left Section */}
